    ...
    <div className="">
      <div className=" relative lg:text-start text-center pb-[40px] lg:pb-[150px]">
       ...
       <div className="padding  lg:flex-row flex-col-reverse lg:space-y-0 space-y-[30px] lg:-space-x-[50px] relative flex justify-center ">
          <div>
            <div className="bg-white mt-[30px] lg:mt-[180px] overflow-hidden border-[4px] border-[#425164] h-fit z-10 p-[24px] lg:p-[32px] lg:w-[547px] rounded-[18px] flex flex-wrap lg:flex-nowrap items-center">
  <div>

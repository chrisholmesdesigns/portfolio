  ...
  return (
    ...
    >
      ...
      >
        ...
        <textarea
            placeholder={placeHolder}
           className={`lg:text-[${textSize}px] text-[${textSm}px] ml-1 h-72 pt-4 pb-4 flex items-center text-left justify-center placeholder-current bg-transparent focus:outline-none text-center text-[#425164] w-full font-[800] uppercase`}
            onChange={(e) => onChange(e.target.value)}
          />
          )
          : (
          <p
            ...
            className={`lg:text-[${textSize}px] text-[${textSm}px] ml-2 mr-2 pt-4 pb-4 w-auto text-[#425164] font-[800] uppercase`}
          >
            {text}
          </p>
        )}

  ...
  return (
    ...
    >
      ...
      >
        ...
        <textarea
            placeholder={placeHolder}
           className={`lg:text-[${textSize}px] text-[${textSm}px] h-72 pt-4 pb-4 flex items-center justify-center placeholder-current bg-transparent focus:outline-none text-center text-[#425164] w-48 font-[800] uppercase`}
            onChange={(e) => onChange(e.target.value)}
          />
          )
          : (

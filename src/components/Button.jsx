  ...
  return (
    ...
    >
      ...
      >
        ...
        <textarea
            placeholder={placeHolder}
           className={`lg:text-[${textSize}px] text-[${textSm}px] ml-6 ml-r h-72 pt-4 pb-4 flex  text-left placeholder-current bg-transparent focus:outline-none text-[#425164] w-full font-[800] uppercase`}
            onChange={(e) => onChange(e.target.value)}
          />
          )
          : (
          <p
            ...
            className={`lg:text-[${textSize}px] text-[${textSm}px] items-center ml-2 mr-2 justify-center 4 h-auto w-auto text-[#425164] font-[800] uppercase`}
          >
            {text}
          </p>
        )}

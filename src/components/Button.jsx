      ...
      >
        {Editable ? (
          <textarea
            ...
            className={`lg:text-[${textSize}px] flex items-center justify-center p-[10px] text-[${textSm}px] placeholder-current bg-transparent focus:outline-none text-[#425164] w-full font-[800] uppercase`}
          />
        ) : (
          <p
